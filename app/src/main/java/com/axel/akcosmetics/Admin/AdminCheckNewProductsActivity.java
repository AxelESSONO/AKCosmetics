...
public class AdminCheckNewProductsActivity extends AppCompatActivity
{
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerOptions<Products> options =
                ...
                .setQuery(unverifiedProductsRef.orderByChild("productState").equalTo("Pas approuvé"), Products.class)
                .build();
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Products model)
                    {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener()
                        {
                            ...
                            public void onClick(View v)
                            {
                                ...
                                builder.setTitle("Approuvez-vous ce produit? Etes-vous sûr?");
    ...
    private void changeProductState(String productId)
    {
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>()
        {
            ...
            {
                Toast.makeText(AdminCheckNewProductsActivity.this, "Cet article a été approuvé et il est désormais disponible à la vente auprès du vendeur.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
